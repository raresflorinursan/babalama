...
export const Route = createFileRoute("/_authenticated/ask-question")({
  head: () => ({
    meta: [
      { title: "Frage stellen — Solvix" },
      {
        name: "description",
        content: "Stelle eine Coding- oder KI-Frage an die Solvix Community.",
      },
    ],
  }),
    ...
    <SiteShell>
      <section className="bg-gradient-hero">
        <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
          ...
          <p className="mt-2 text-muted-foreground">
            Beschreibe dein Problem so präzise wie möglich.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        ...
        >
          ...
          >
            {loading ? "Wird gesendet…" : "Frage veröffentlichen"}
          </Button>
        </form>
      </section>
    </SiteShell>
